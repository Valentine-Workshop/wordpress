 ...
 *
 * Passes it through the `vw_starter_content` filter before returning.
 *
 * @since Twenty Twenty-One 1.0
 *
 * @return array A filtered array of args for the starter_content.
 */
function vw_get_starter_content() {
	 ...
	 */
	return apply_filters( 'vw_starter_content', $starter_content );
}
